...
import getDepartmentFlights2019 from "./queries/flight2019/getDepartmentFlights2019";
...
const getDepartmentOdMatrix = async (departmentId: string) => {
...
const getODFlows = async (
  ...
  const flights = await getDepartmentFlights2019(departmentId);
...
export default getDepartmentOdMatrix;
